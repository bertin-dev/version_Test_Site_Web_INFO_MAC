...
$query->closeCursor();
// On supprime les inscription qui ne sont pas sur le chat,
...
// Récupère les inscription en ligne sur le chat
...
// On compte le nombre de inscription
$count = $query->rowCount();
...
while($data = $query->fetch())
{
	...
	// On enregistre dans la colonne [status] du tableau
		...
		$accounts[$i] = $infos;
		$i++;
	//on compte le nombre de inscription en ligne
