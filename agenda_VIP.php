		...
		<div class="row">
			<div class="col-lg-8">
				...
				<article>
						<div class="post-image">
							...
							<img src="img/dummies/blog/Diplomate avec Coin Or big.png" alt="" class="img-responsive" />
						</div>
						<p>tranche: Naturelle Personnalisation: Marquage au laser, en sérigraphie ou doming poids / Format: 550g - 195 * 265 mm couleur: Unique Zone de marquage: 100 * 60 mm
						</p>
						<p>
			...
			<div class="col-lg-4">
				...
				<div class="widget">
					...
					<ul class="cat">
						<li><i class="fa fa-angle-right"></i><a href="senateur.php">Senateur</a></li>
						<li><i class="fa fa-angle-right"></i><a href="diplomate.php">Diplomate</a></li>
						<li><i class="fa fa-angle-right"></i><a href="consul.php">Consul</a></li>
					</ul>
				</div>
				<div class="widget">
					...
					<ul class="recent">
						...
						<img src="img/dummies/blog/Consul.png" class="pull-left" alt="" />
				...
				<ul class="recent">
						<li>
				<img src="img/dummies/blog/Diplomate.png" class="pull-left" alt="" />
				</li>
				</ul>
