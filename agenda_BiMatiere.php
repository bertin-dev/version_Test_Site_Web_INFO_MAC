...
<head>
<meta charset="utf-8">
<title>AGENDA_BIMATIERE | INFO-MAC.FR</title>
...
<div id="wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					<li><a href="index.html" title="Accueil"><i class="fa fa-home"></i></a><i class="icon-angle-right"></i></li>
					<li><a href="#">Agenda</a><i class="icon-angle-right"></i></li>
					<li class="active">Bi-Matière</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8">
				...
				<article>
						<div class="post-image">
							...
							<img src="img/dummies/blog/premium big.png" alt="" class="img-responsive" />
							<strong>Caractéristiques: </strong> tranche: Naturelle Personnalisation: Marquage au laser, en sérigraphie ou doming poids / Format: 550g - 195 * 265 mm couleur: Unique Zone de marquage: 100 * 60 mm
						</div>
						<p>
			...
			<div class="col-lg-4">
				...
				<div class="widget">
					<h5 class="widgetheading">Modèles Premium</h5>
					<ul class="cat">
						<li><i class="fa fa-angle-right"></i><a href="agenda_BiMatiere.php">Premium</a></li>
						<li><i class="fa fa-angle-right"></i><a href="blue_shine.php">Blue Shine</a></li>
					</ul>
				</div>
				<div class="widget">
					<h5 class="widgetheading">Dernier Post</h5>
					<img src="img/dummies/blog/premium.png" alt="" class="img-responsive" />
				</div>
				<div class="widget">
				...
				<div class="widget">
				<h5 class="widgetheading">Flyer 2017</h5>
				<ul class="tags">
				<img src="img/dummies/blog/17.jpg" alt="" class="img-responsive" />
				</ul>
