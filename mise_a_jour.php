...
<div class="thumbnail" style="background-color:rgba();" >
			...
			<span>	
				...
				<div style="background-color:rgba(0,0,0,0.1); font-size:1.1em;margin-top:0.3em;border-left:5px solid rgba(245,76,16,1);padding:0.5em;border-radius:5px;">
					...
					<div style="margin-top:0.3em;"><b> Prenom : </b> <span style="color:grey;font-weight:bold;"><?php echo  $rslt001['prenom'];?></span></div>
					 ...
					 <div align="right" style="background-color:white;"> 	
								...
								<div style="margin-top:0.2em;display:none;border:0px solid;background-color:rgba(0,0,0,0.12);padding:1em;" id="block_infos" align="left">
									...
									<fieldset>
										<div class="row-fluid">
											<div class="span6">
												<input type="text" id="nom" value="<?php echo $rslt001['nom'];?>" class="input-xxlarge" placeholder="Nom complet" name="nom" style="font-size:1.3em; height:1.7em;" required>
											</div>
										</div>
										
										<div class="row-fluid">    
											<div class="span6">
												<input type="text" id="contact" value="<?php echo $rslt001['prenom'];?>" class="input-xxlarge" placeholder="^prenom" name="contact" style="font-size:1.3em; height:1.7em;" required>
											</div>
										</div>
	...
	$('#photo').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success:function(data){
				...
				$('body').load('modifier_profil.php', function() {
