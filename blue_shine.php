	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8">
				...
				<article>
						<div class="post-image">
							...
							<img src="img/dummies/blog/blue shine big.png" alt="" class="img-responsive" />
			...
			<div class="col-lg-4">
				...
				<div class="widget">
					<h5 class="widgetheading">Modèles Bi-Matières</h5>
					<ul class="cat">
						<li><i class="fa fa-angle-right"></i><a href="agenda_Standard.php">Premium</a></li>
						<li><i class="fa fa-angle-right"></i><a href="class.php">Blue Shine</a></li>
					</ul>
				</div>
				<div class="widget">
					...
					<ul class="recent">
						...
						<img src="img/dummies/blog/blue shine.png" class="pull-left" alt="" />
